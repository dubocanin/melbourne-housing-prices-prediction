...
plot(cv.ridge, cex.axis = 1.25 , cex = 1.25, xlab="", ylab="") ## cex is scaling (up/down), familiy is teh font and the rest to remove axis names 
mtext(side=1, line = 2, "log(Lambda)", cex = 1.25) ## editing x-axis name size etc
mtext(side=2, line = 3, "Mean-Squared Error", cex = 1.25) ## editing y-axis name size etc
